...
* The original package name 'com.zappqui.api.auth.zappqui-auth-service' is invalid and this project uses 'com.zappqui.api.auth.zappqui_auth_service' instead.
